...
export default function Dashboard() {
  ...
  const INACTIVITY_LIMIT = 60 * 1000; // ajusta a gusto (ej. 15 * 60 * 1000 para 15 minutos)
  const WARNING_BEFORE = 15 * 1000; // avisar X segundos antes de cerrar
          ...
          {showProfile && (
            <div className="profile-dropdown-card" style={{
              ...
              <button
                ...
                onClick={() => { setShowProfile(false); nav("/profile/edit"); }}
              >
                Editar Perfil
              </button>
